...
export const targetStopLossCalculatorConfig: CalculatorConfig = {
  ...
  description: 'Calculate target and stop loss prices for your share investments.',
  inputs: [
    {
      id: 'shareQuantity',
...
export const positionCalculatorConfig: CalculatorConfig = {
  ...
  description: 'Calculate profit/loss scenarios for different price movements from your purchase price to plan your exit strategy.',
  inputs: [
    {
      id: 'purchasePrice',
